...
import { Blog, BlogDAOService, BlogViewModelService } from './blog.service';
...
describe('BlogDAOService', () => {
  ...
  it('query', inject(
    [BlogDAOService, HttpTestingController],
    (dao: BlogDAOService, httpMock: HttpTestingController) => {
      dao.query().subscribe(
        (data) => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        LoggerService,
        {
          provide: BlogDAOService,
          useFactory: (http: HttpClient) =>
            new DAOServiceMock<any, number>(http, [
              { id: 17, titulo: '444', autor: 'Yo', fecha: '2021-10-17' },
              {
                texto:
                  '<p><span style="color: rgb(255, 153, 0);">wqdwedwdww</span></p>',
                titulo: 'dewed',
                id: 21,
                fecha: '2021-10-17',
                autor: 'admin',
              ...
              {
                id: 11,
                titulo: 'Version 11 of Angular Now Available',
                texto:
                  '<p>Version 11.0.0 is here and we’ve got some great updates for Angular developers everywhere. This release has updates across the platform including the framework, the CLI and components. Let’s dive in!</p><h1>What’s in this release?</h1><ul><li>Updates on Operation Byelog</li><li>Automatic Inlining of Fonts</li><li>Component Test Harnesses</li><li>Improved Reporting and Logging</li><li>Updated Language Service Preview</li></ul><p><br></p><h1><span style="background-color: rgb(255, 255, 255);"><img src="https://miro.medium.com/max/1500/0*L1Tg13gdu3PCqUNN" alt="Screenshot of intellisense style insights in Angular templates." height="902" width="1500"></span>Experimental webpack 5 Support</h1><p><br></p><p><br></p>',
                autor: 'Mark Techson',
                fecha: '2020-11-12',
                fotourl: 'https://miro.medium.com/max/700/0*55kr1t601sp22pkE',
              },
              {"id":14,"titulo":"TEST22wwee7ww","fecha":"2021-10-17"},
            ]),
          deps: [HttpClient],
        },
      ],
